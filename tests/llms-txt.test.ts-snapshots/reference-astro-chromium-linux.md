...
Arcjet is configured as an integration in your `astro.config.mjs` file. Add your Cloud API key as an environment variable and configure the rules you want to apply.
...
Arcjet supports Astro v5.9.3 and later. We follow [Astro’s support policy](https://docs.astro.build/en/upgrade-astro/#extended-maintenance) and provide support for all versions that are actively maintained by the Astro team.
