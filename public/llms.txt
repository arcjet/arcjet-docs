...
- [Agent guard integrations](https://docs.arcjet.com/guards/framework-integrations): Vercel AI SDK, LangChain, LangChain JS, CrewAI, LangGraph, Genkit, OpenAI Agents, OpenAI Agents Python, Strands Agents, TanStack AI, Vercel Eve, Mastra, Claude Agent SDK, Claude Agent SDK Python, and Claude Managed Agents. One `ArcjetDenialResult` payload; per-framework envelopes.
