...
/**
 * Official Cloudflare mark from Simple Icons (`cloudflare`).
 * `currentColor` so it matches the other tech icons.
 *
 * @see {@link https://simpleicons.org/icons/cloudflare/ | Simple Icons Cloudflare}
 */
