...
import CharacteristicsGlobalRule from "/src/snippets/rate-limiting/reference/nextjs/CharacteristicsGlobalRule.ts?raw";
...
configurations can be used for each rule and globally on the SDK root instance.
