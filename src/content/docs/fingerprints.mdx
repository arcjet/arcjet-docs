...
description: "How Arcjet identifies a client when you don't supply a key, and how to set `characteristics` so rate limits and other rules track the identity you care about."
next: false
---
...
```py
# Pass userId in the `characteristics` dict to identify the user. Values can be
