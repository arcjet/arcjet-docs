...
version of the Arcjet JS SDK was released on 2026-01-22. No migrations are required from the last `1.0.0-beta-18` release.
...
If you use tools that patch `request.body` e.g. [`body-parser`](https://www.npmjs.com/package/body-parser) you are not affected and can continue to use them.
...
now handle both raw and URL-encoded data simultaneously. This dual processing
approach ensures comprehensive detection, particularly for content containing
