...
version of the Arcjet JS SDK was released on 2026-01-22 and includes no breaking changes.
It is the same as the latest beta release `1.0.0-beta-18`.

## Arcjet JS SDK 1.0.0 beta 18

The
[`1.0.0-beta-18`](https://github.com/arcjet/arcjet-js/releases/tag/v1.0.0-beta.18)
version of the Arcjet JS SDK was released on 2026-01-22 and includes the
...
If you use tools such as `body-parser`, which patch `request.body`, you are not affected.
...
version of the Arcjet JS SDK was released on 2026-01-13 and includes the
following breaking changes.

### Add limits to web streams

In Arcjet SDKs that use web streams (such as the `Request` object in Deno and React Router),
those are now limited to a maximum size of 1MB.
These limits already applied to Node.js streams.

### Remove `block` field in `validateEmail` rule config

This fields was deprecated in
...
## Arcjet JS SDK 1.0.0 beta 16

The
[`1.0.0-beta-16`](https://github.com/arcjet/arcjet-js/releases/tag/v1.0.0-beta.16)
version of the Arcjet JS SDK was released on 2026-01-06 and includes the
following breaking changes.

### Remove `apiKey` utility from `@arcjet/env`

You can read the `ARCJET_KEY` environment variable directly instead.
See [“How to read environment variables”](https://docs.arcjet.com/environment#how-to-read-environment-variables)
for more info.

## Arcjet JS SDK 1.0.0 beta 14

The
[`1.0.0-beta-14`](https://github.com/arcjet/arcjet-js/releases/tag/v1.0.0-beta.14)
version of the Arcjet JS SDK was released on 2025-11-04 and includes the
following breaking changes.

### Drop support for Node 18

Node 18 reached end-of-life.
...
[Arcjet Sensitive info detection](/sensitive-info) and
