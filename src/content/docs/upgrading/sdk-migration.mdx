...
## Arcjet Python SDK 1.0.0

The Python SDK 1.0.0 includes the following breaking changes.
...
Drop `threshold` when you upgrade to Python SDK 1.0.0. Passing `threshold=`
