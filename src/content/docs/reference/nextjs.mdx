...
import SDKVersionNextjs from "../../../components/SDKVersionNextjs.astro";
import WhatIsArcjet from "/src/components/WhatIsArcjet.astro";
import ConfigurationTS from "/src/content/docs/reference/snippets/nextjs/Configuration.ts?raw";
import ConfigurationJS from "/src/content/docs/reference/snippets/nextjs/Configuration.js?raw";
import MultipleRulesTS from "/src/content/docs/reference/snippets/nextjs/MultipleRules.ts?raw";
import MultipleRulesJS from "/src/content/docs/reference/snippets/nextjs/MultipleRules.js?raw";
import LoggerTS from "/src/content/docs/reference/snippets/nextjs/Logger.ts?raw";
import LoggerJS from "/src/content/docs/reference/snippets/nextjs/Logger.js?raw";
import ClientOverrideTS from "/src/content/docs/reference/snippets/nextjs/ClientOverride.ts?raw";
import ClientOverrideJS from "/src/content/docs/reference/snippets/nextjs/ClientOverride.js?raw";
import ProtectAppTS from "/src/content/docs/reference/snippets/nextjs/ProtectApp.ts?raw";
import ProtectPagesTS from "/src/content/docs/reference/snippets/nextjs/ProtectPages.ts?raw";
import ProtectAppJS from "/src/content/docs/reference/snippets/nextjs/ProtectApp.js?raw";
import ProtectPagesJS from "/src/content/docs/reference/snippets/nextjs/ProtectPages.js?raw";
import ServerAction from "/src/content/docs/reference/snippets/nextjs/ServerAction.tsx?raw";
import WithRuleAppTS from "/src/content/docs/reference/snippets/nextjs/WithRuleApp.ts?raw";
import WithRulePagesTS from "/src/content/docs/reference/snippets/nextjs/WithRulePages.ts?raw";
import WithRuleAppJS from "/src/content/docs/reference/snippets/nextjs/WithRuleApp.js?raw";
import WithRulePagesJS from "/src/content/docs/reference/snippets/nextjs/WithRulePages.js?raw";
import DecisionLogAppTS from "/src/content/docs/reference/snippets/nextjs/DecisionLogApp.ts?raw";
import DecisionLogPagesTS from "/src/content/docs/reference/snippets/nextjs/DecisionLogPages.ts?raw";
import DecisionLogAppJS from "/src/content/docs/reference/snippets/nextjs/DecisionLogApp.js?raw";
import DecisionLogPagesJS from "/src/content/docs/reference/snippets/nextjs/DecisionLogPages.js?raw";
import IPLocationAppTS from "/src/content/docs/reference/snippets/nextjs/IPLocationApp.ts?raw";
import IPLocationPagesTS from "/src/content/docs/reference/snippets/nextjs/IPLocationPages.ts?raw";
import IPLocationAppJS from "/src/content/docs/reference/snippets/nextjs/IPLocationApp.js?raw";
import IPLocationPagesJS from "/src/content/docs/reference/snippets/nextjs/IPLocationPages.js?raw";
import ErrorHandlingAppTS from "/src/content/docs/reference/snippets/nextjs/ErrorHandlingApp.ts?raw";
import ErrorHandlingPagesTS from "/src/content/docs/reference/snippets/nextjs/ErrorHandlingPages.ts?raw";
import ErrorHandlingAppJS from "/src/content/docs/reference/snippets/nextjs/ErrorHandlingApp.js?raw";
import ErrorHandlingPagesJS from "/src/content/docs/reference/snippets/nextjs/ErrorHandlingPages.js?raw";
...
Check out the [quick start guide](/get-started/nextjs).
...
- `rules` - The rules to apply to the request. See the various sections of the
  docs for how to configure these e.g. [shield](/shield/reference/nextjs), [rate
  limiting](/rate-limiting/reference/nextjs), [bot
  protection](/bot-protection/reference/nextjs), [email
  validation](/email-validation/reference/nextjs).
...
Arcjet currently doesn't support Next.js server actions directly because the
request context is not passed to the handler. Full support for server actions is
[on our roadmap](https://github.com/arcjet/arcjet-js/issues/1200). In the
meantime, the workaround is to create the request object manually.

This is an example form that calls a server action on submission and uses Arcjet
to validate it. It uses [the Next.js headers
function](https://nextjs.org/docs/app/api-reference/functions/headers) to get
the request context. The client IP address is also parsed out, which can be
replaced by the [Vercel Functions IP helper
package](https://vercel.com/docs/functions/vercel-functions-package#ipaddress)
if you are deploying on Vercel.

<Code code={ServerAction} title="/app/form/page.tsx" lang="ts" />
...
See the [shield documentation](/shield/reference/nextjs) for more information
...
```ts
// See https://docs.arcjet.com/bot-protection/bot-types#bot-detection-result
...
An `ArcjetBotType` is one of the following strings:

```ts
// See https://docs.arcjet.com/bot-protection/bot-types
// for an explanation of each prop
"NOT_ANALYZED" |
  "AUTOMATED" |
  "LIKELY_AUTOMATED" |
...
See the [bot protection documentation](/bot-protection/reference/nextjs) for
...
See the [rate limiting documentation](/rate-limiting/reference/nextjs) for more
...
See the [email validation documentation](/email-validation/reference/nextjs) for
more information about these properties.
...
<Tabs>
  <TabItem label="TS (App)">
    <Code code={ErrorHandlingAppTS} title="/app/api/route/hello.ts" lang="ts" />
  </TabItem>
  <TabItem label="TS (Pages)">
    <Code code={ErrorHandlingPagesTS} title="/pages/api/hello.ts" lang="ts" />
  </TabItem>
  <TabItem label="JS (App Router)">
    <Code code={ErrorHandlingAppJS} title="/app/api/route/hello.js" lang="js" />
  </TabItem>
  <TabItem label="JS (Pages Router)">
    <Code code={ErrorHandlingPagesJS} title="/pages/api/hello.js" lang="js" />
  </TabItem>
</Tabs>
...
Arcjet supports the current major version of Next.js for both the app router and
pages router. When a new major version of Next.js is released, we will bump the
major version of the Arcjet SDK.

- Current supported major version: Next.js 14.x
