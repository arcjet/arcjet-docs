...
Arcjet supports server actions in both Next.js for all features except sensitive
data detection. You need to call a utility function `request()` that accesses
the headers we need to analyze the request.
