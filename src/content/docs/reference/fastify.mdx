...
Get your Arcjet Cloud API key from the [Arcjet dashboard][arcjet-app].
...
The Arcjet Fastify SDK works with Node.js environment variable support
(`process.env`).
...
The Arcjet Fastify SDK uses several environment variables to configure its behavior.
