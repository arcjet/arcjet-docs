...
description: "Reference for the Arcjet Fastify SDK: install `@arcjet/fastify`, configure a client, protect a route or hook, and read the decision."
...
[<NpmSdkVersion packageName="@arcjet/fastify" />](https://www.npmjs.com/package/@arcjet/fastify)

This guide shows how to use the package
[`@arcjet/fastify`](https://www.npmjs.com/package/@arcjet/fastify).
Its source code is [on GitHub](https://github.com/arcjet/arcjet-js/tree/main/arcjet-fastify).
...
See the <Link.ToSdk href="/get-started" sdk="fastify">Fastify quick start</Link.ToSdk>.
...
The main way to configure Arcjet is to pass options to the `arcjet` function. It
...
The Arcjet Fastify SDK uses several environment variables to configure its
