...
The Arcjet Astro SDK works with Astro environment variable support.
You can use `.env` files which are automatically loaded.
See [“Using environment variables” in the Astro
docs](https://docs.astro.build/en/guides/environment-variables/) for more info.
