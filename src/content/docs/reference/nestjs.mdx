...
The Arcjet NestJS SDK works with Node.js environment variable support
(`process.env`).
...
The Arcjet NestJS SDK uses several environment variables to configure its behavior.
