...
description: "Reference for the Arcjet NestJS SDK: install `@arcjet/nest`, configure the module, protect a route with a global or per-route guard, and read the decision."
next: false
