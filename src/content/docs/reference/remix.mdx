---
title: "Arcjet Remix SDK reference"
description: "Reference for the Arcjet Remix SDK: install `@arcjet/remix`, configure a client, protect a loader or action, and read the decision."
next: false
...
import MultipleRulesTS from "/src/snippets/reference/remix/MultipleRules.ts?raw";
import MultipleRulesJS from "/src/snippets/reference/remix/MultipleRules.js?raw";
import ProtectTS from "/src/snippets/reference/remix/Protect.ts?raw";
...
import CloudflareTS from "/src/snippets/reference/remix/Cloudflare.ts?raw";
...
import WithRuleJS from "/src/snippets/reference/remix/WithRule.js?raw";
import ConfigurationTS from "/src/snippets/reference/remix/Configuration.ts?raw";
import ConfigurationJS from "/src/snippets/reference/remix/Configuration.js?raw";
import ClientOverrideTS from "/src/snippets/reference/remix/ClientOverride.ts?raw";
import ClientOverrideJS from "/src/snippets/reference/remix/ClientOverride.js?raw";
import ErrorLoggingTS from "/src/snippets/reference/remix/ErrorLogging.ts?raw";
import ErrorLoggingJS from "/src/snippets/reference/remix/ErrorLogging.js?raw";
import ErrorUserAgentTS from "/src/snippets/reference/remix/ErrorUserAgent.ts?raw";
import ErrorUserAgentJS from "/src/snippets/reference/remix/ErrorUserAgent.js?raw";
...
[<NpmSdkVersion packageName="@arcjet/remix" />](https://www.npmjs.com/package/@arcjet/remix)
...
See the <Link.ToSdk href="/get-started" sdk="remix">quick start guide</Link.ToSdk>.
...
- `rules` - The rules to apply to the request. See the various sections of the
  ...
  <Link.ToSdk href="/shield/reference" sdk="remix">shield</Link.ToSdk>,
  <Link.ToSdk href="/rate-limiting/reference" sdk="remix">rate limiting</Link.ToSdk>,
  <Link.ToSdk href="/bot-protection/reference" sdk="remix">bot protection</Link.ToSdk>,
  <Link.ToSdk href="/email-validation/reference" sdk="remix">email validation</Link.ToSdk>.
...
The Arcjet Remix SDK uses several environment variables to configure its
...
For Remix, `requestInput` in the following example is the loader or action
arguments.
...
For more information about these properties, see the <Link.ToSdk href="/rate-limiting/reference" sdk="remix">rate limiting documentation</Link.ToSdk>.
...
For more information about these properties, see the <Link.ToSdk href="/email-validation/reference" sdk="remix">email validation documentation</Link.ToSdk>.
...
<Tabs>
  <TabItem label="TS">
    <Code code={ErrorLoggingTS} lang="ts" mark={[{ range: "20-27" }]} />
  </TabItem>
  <TabItem label="JS">
    <Code code={ErrorLoggingJS} lang="js" mark={[{ range: "19-26" }]} />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="TS">
    <Code code={ErrorUserAgentTS} lang="ts" mark={[{ range: "22-30" }]} />
  </TabItem>
  <TabItem label="JS">
    <Code code={ErrorUserAgentJS} lang="js" mark={[{ range: "21-29" }]} />
  </TabItem>
</Tabs>
