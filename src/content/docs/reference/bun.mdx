...
import SDKVersionBun from "../../../components/SDKVersionBun.astro";
import WhatIsArcjet from "/src/components/WhatIsArcjet.astro";
import ConfigurationTS from "/src/content/docs/reference/snippets/bun/Configuration.ts?raw";
import ConfigurationJS from "/src/content/docs/reference/snippets/bun/Configuration.js?raw";
import MultipleRulesTS from "/src/content/docs/reference/snippets/bun/MultipleRules.ts?raw";
import MultipleRulesJS from "/src/content/docs/reference/snippets/bun/MultipleRules.js?raw";
import LoggerTS from "/src/content/docs/reference/snippets/bun/Logger.ts?raw";
import LoggerJS from "/src/content/docs/reference/snippets/bun/Logger.js?raw";
import ProtectTS from "/src/content/docs/reference/snippets/bun/Protect.ts?raw";
import ProtectJS from "/src/content/docs/reference/snippets/bun/Protect.js?raw";
import DecisionLogTS from "/src/content/docs/reference/snippets/bun/DecisionLog.ts?raw";
import DecisionLogJS from "/src/content/docs/reference/snippets/bun/DecisionLog.js?raw";
import ErrorHandlingTS from "/src/content/docs/reference/snippets/bun/ErrorHandling.ts?raw";
import ErrorHandlingJS from "/src/content/docs/reference/snippets/bun/ErrorHandling.js?raw";
import ClientOverrideTS from "/src/content/docs/reference/snippets/bun/ClientOverride.ts?raw";
import ClientOverrideJS from "/src/content/docs/reference/snippets/bun/ClientOverride.js?raw";
import WithRuleTS from "/src/content/docs/reference/snippets/bun/WithRule.ts?raw";
import WithRuleJS from "/src/content/docs/reference/snippets/bun/WithRule.js?raw";
...
protection rules. This requires a `request` object which is the event
...
See the [bot protection documentation](/bot-protection/reference/bun) for
...
SDKs work correctly locally. As Bun doesn't set `NODE_ENV` for you like Node.js
does, you need to set `ARCJET_ENV=development` in your environment file
for this to work.
...
releases](https://github.com/oven-sh/bun/releases) since v1.1.13.
