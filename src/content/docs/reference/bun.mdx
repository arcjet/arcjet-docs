...
The Arcjet Bun SDK works with Bun environment variable support.
You can use `.env` files which are automatically loaded.
See [“Environment variables” in the Bun
docs](https://bun.com/docs/runtime/environment-variables) for more info.
...
in development (see [`ARCJET_ENV`](/concepts/environment#arcjet-env)) and 500ms
