...
It is recommended to use [`@arcjet/node`][arcjet-node].
...
[`@arcjet/astro`][arcjet-astro],
[`@arcjet/fastify`][arcjet-fastify],
[`@arcjet/next`][arcjet-next],
[`@arcjet/nuxt`][arcjet-nuxt], and
[`@arcjet/sveltekit`][arcjet-sveltekit],
respectively.
:::
...
[arcjet-astro]: /reference/astro
[arcjet-fastify]: /reference/fastify
[arcjet-next]: /reference/nextjs
[arcjet-node]: /reference/nodejs
[arcjet-nuxt]: /reference/nuxt
[arcjet-sveltekit]: /reference/sveltekit
