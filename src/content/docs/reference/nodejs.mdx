...
- `rules` - The rules to apply to the request. See the various sections of the
  docs for how to configure these e.g. [shield](/shield/reference?f=nodejs), [rate
  limiting](/rate-limiting/reference?f=nodejs), [bot
  protection](/bot-protection/reference?f=nodejs), [email
  validation](/email-validation/reference?f=nodejs).
...
See the [rate limiting documentation](/rate-limiting/reference?f=nodejs) for more
...
See the [email validation documentation](/email-validation/reference?f=nodejs) for more
information about these properties.
