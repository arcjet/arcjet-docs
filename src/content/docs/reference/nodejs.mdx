...
import SDKVersionNodejs from "../../../components/SDKVersionNodejs.astro";
import WhatIsArcjet from "/src/components/WhatIsArcjet.astro";
import MultipleRulesTS from "/src/content/docs/reference/snippets/nodejs/MultipleRules.ts?raw";
import MultipleRulesJS from "/src/content/docs/reference/snippets/nodejs/MultipleRules.js?raw";
import ProtectTS from "/src/content/docs/reference/snippets/nodejs/Protect.ts?raw";
import ProtectJS from "/src/content/docs/reference/snippets/nodejs/Protect.js?raw";
import LoggerTS from "/src/content/docs/reference/snippets/nodejs/Logger.ts?raw";
import LoggerJS from "/src/content/docs/reference/snippets/nodejs/Logger.js?raw";
import IPLocationTS from "/src/content/docs/reference/snippets/nodejs/IPLocation.ts?raw";
import IPLocationJS from "/src/content/docs/reference/snippets/nodejs/IPLocation.js?raw";
import WithRuleTS from "/src/content/docs/reference/snippets/nodejs/WithRule.ts?raw";
import WithRuleJS from "/src/content/docs/reference/snippets/nodejs/WithRule.js?raw";
import ConfigurationTS from "/src/content/docs/reference/snippets/nodejs/Configuration.ts?raw";
import ConfigurationJS from "/src/content/docs/reference/snippets/nodejs/Configuration.js?raw";
import ClientOverrideTS from "/src/content/docs/reference/snippets/nodejs/ClientOverride.ts?raw";
import ClientOverrideJS from "/src/content/docs/reference/snippets/nodejs/ClientOverride.js?raw";
...
Check out the [quick start guide](/get-started/nodejs).
...
- `rules` - The rules to apply to the request. See the various sections of the
  docs for how to configure these e.g. [shield](/shield/reference/nodejs), [rate
  limiting](/rate-limiting/reference/nodejs), [bot
  protection](/bot-protection/reference/nodejs), [email
  validation](/email-validation/reference/nodejs).
...
See the [bot protection documentation](/bot-protection/reference/nodejs) for more
...
See the [rate limiting documentation](/rate-limiting/reference/nodejs) for more
information about these properties.
...
See the [email validation documentation](/email-validation/reference/nodejs) for more
information about these properties.
