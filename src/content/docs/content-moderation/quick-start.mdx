...
description: "Quick start for Arcjet content moderation on Guard in JavaScript and Go."
---
...
Python still exports `experimental_ModerateContent`. That rule is experimental
and may fail open; do not use it as a stable API. See
<Link.Page href="/content-moderation#sdk-availability">SDK availability</Link.Page>.
