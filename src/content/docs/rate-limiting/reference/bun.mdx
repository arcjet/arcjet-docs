---
title: "Bun rate limiting reference"
description: "How to use Arcjet to add rate limiting to your Bun app."
next: false
---

import { Tabs, TabItem, Code } from "@astrojs/starlight/components";
import FixedWindow from "/src/content/docs/rate-limiting/reference/snippets/bun/FixedWindow.ts?raw";
import SlidingWindow from "/src/content/docs/rate-limiting/reference/snippets/bun/SlidingWindow.ts?raw";
import TokenBucket from "/src/content/docs/rate-limiting/reference/snippets/bun/TokenBucket.ts?raw";
import ByUserIdTS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByUserId.ts?raw";
import ByUserIdJS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByUserId.js?raw";
import SingleRateLimit from "/src/content/docs/rate-limiting/reference/snippets/bun/SingleRateLimit.ts?raw";
import DryRun from "/src/content/docs/rate-limiting/reference/snippets/bun/DryRun.ts?raw";
import DecisionLogTS from "/src/content/docs/rate-limiting/reference/snippets/bun/DecisionLog.ts?raw";
import DecisionLogJS from "/src/content/docs/rate-limiting/reference/snippets/bun/DecisionLog.js?raw";
import TokenBucketRequestTS from "/src/content/docs/rate-limiting/reference/snippets/bun/TokenBucketRequest.ts?raw";
import TokenBucketRequestJS from "/src/content/docs/rate-limiting/reference/snippets/bun/TokenBucketRequest.js?raw";
import HeadersTS from "/src/content/docs/rate-limiting/reference/snippets/bun/Headers.ts?raw";
import HeadersJS from "/src/content/docs/rate-limiting/reference/snippets/bun/Headers.js?raw";
import ErrorsTS from "/src/content/docs/rate-limiting/reference/snippets/bun/Errors.ts?raw";
import ErrorsJS from "/src/content/docs/rate-limiting/reference/snippets/bun/Errors.js?raw";
import ByIPTS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByIP.ts?raw";
import ByIPJS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByIP.js?raw";
import ByIPCustomResponseTS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByIPCustomResponse.ts?raw";
import ByIPCustomResponseJS from "/src/content/docs/rate-limiting/reference/snippets/bun/ByIPCustomResponse.js?raw";
import ByAPIKeyHeader from "/src/content/docs/rate-limiting/reference/snippets/bun/ByAPIKeyHeader.ts?raw";
