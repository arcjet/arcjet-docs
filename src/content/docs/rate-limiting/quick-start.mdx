...
titleByFramework:
  ...
  bun: "Rate limiting with Bun"
  nest-js: "Rate limiting with NestJS"
  next-js: "Rate limiting with Next.js"
  node-js: "Rate limiting with Node.js"
  remix: "Rate limiting with Remix"
  sveltekit: "Rate limiting with SvelteKit"
