...
<Link.Page href="/rate-limiting/configuration">Configuration</Link.Page>
documentation. See the
<Link.Page href="/rate-limiting/algorithms#fixed-window">fixed window algorithm description</Link.Page>
...
<Link.Page href="/rate-limiting/configuration">Configuration</Link.Page>
documentation. See the
<Link.Page href="/rate-limiting/algorithms#sliding-window">sliding window algorithm description</Link.Page>
for more details about how the algorithm works.
...
<Link.Page href="/rate-limiting/configuration">Configuration</Link.Page>
documentation. See the
<Link.Page href="/rate-limiting/algorithms#token-bucket">token bucket algorithm description</Link.Page>
for more details about how the algorithm works.
...
When using a token bucket rule, an additional `requested` prop (positive
