...
description: "The fixed input contract a coding agent policy reads, the starter policies for Claude Code and GitHub Copilot, and how to write and roll out your own."
---
...
| `agent_surface`   | String      | The optional `surface` query parameter, or `unknown` when omitted          |
