...
expressions over HTTP headers, IP addresses, and other request attributes - so
you can quickly enforce rules like allow/deny by country, network, or user-agent
pattern.
