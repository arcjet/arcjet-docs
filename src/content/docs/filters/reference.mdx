...
Some fields are only available on certain plans:

| Filters                  | <Badge text="Free" variant="caution" /> | <Badge text="Starter" variant="note" /> | <Badge text="Business" variant="tip" /> |
| ------------------------ | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `http.host`              | ✅                                      | ✅                                      | ✅                                      |
| `http.request.cookie`    | ✅                                      | ✅                                      | ✅                                      |
