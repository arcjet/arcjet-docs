---
title: "Node.js sensitive info reference"
description: "How to use Arcjet Sensitive Info to protect your Node.js app."
next: false
---
...
import CustomDetectTS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/CustomDetect.ts?raw";
import CustomDetectJS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/CustomDetect.js?raw";
import DecisionLogTS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/DecisionLog.ts?raw";
import DecisionLogJS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/DecisionLog.js?raw";
import ErrorsTS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/Errors.ts?raw";
import ErrorsJS from "/src/content/docs/sensitive-info/reference/snippets/nodejs/Errors.js?raw";
...
The [quick start example](/sensitive-info/quick-start/nodejs) will deny requests
