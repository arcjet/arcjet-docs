...
custom logic. Just write a function that returns either the name of the entity
or undefined if its not detected. Be sure to add it to either the `deny` or `allow`
list as appropriate.
