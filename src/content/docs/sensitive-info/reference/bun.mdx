...
import CustomDetectTS from "/src/content/docs/sensitive-info/reference/snippets/bun/CustomDetect.ts?raw";
import CustomDetectJS from "/src/content/docs/sensitive-info/reference/snippets/bun/CustomDetect.js?raw";
import DecisionLogTS from "/src/content/docs/sensitive-info/reference/snippets/bun/DecisionLog.ts?raw";
import DecisionLogJS from "/src/content/docs/sensitive-info/reference/snippets/bun/DecisionLog.js?raw";
import ErrorsTS from "/src/content/docs/sensitive-info/reference/snippets/bun/Errors.ts?raw";
import ErrorsJS from "/src/content/docs/sensitive-info/reference/snippets/bun/Errors.js?raw";
...
if the corresponding token in the input list is not sensitive, or the name of the
entity if it does match. The number of tokens that are provided to the function
is controlled by the `contextWindowSize` option, which defaults to 1. If you need
additional context to perform detections then you can increase this value.
