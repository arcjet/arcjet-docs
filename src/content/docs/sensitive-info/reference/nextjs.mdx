...
import EdgeAppTS from "/src/snippets/sensitive-info/reference/nextjs/EdgeApp.ts?raw";
import EdgePagesTS from "/src/snippets/sensitive-info/reference/nextjs/EdgePages.ts?raw";
import EdgeAppJS from "/src/snippets/sensitive-info/reference/nextjs/EdgeApp.js?raw";
import EdgePagesJS from "/src/snippets/sensitive-info/reference/nextjs/EdgePages.js?raw";
...
The [quick start example](/sensitive-info/quick-start?f=next-js) will deny requests
