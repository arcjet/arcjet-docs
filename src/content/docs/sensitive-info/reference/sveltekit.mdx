...
import CustomDetectTS from "/src/content/docs/sensitive-info/reference/snippets/sveltekit/CustomDetect.ts?raw";
import CustomDetectJS from "/src/content/docs/sensitive-info/reference/snippets/sveltekit/CustomDetect.js?raw";
