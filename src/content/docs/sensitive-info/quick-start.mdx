...
Add Arcjet to detect email address from a specific route in your app.

You can also configure Arcjet to detect credit/debit card numbers, IP addresses,
phone numbers, and/or implement a custom detection function.
