...
titleByFramework:
  ...
  bun: "Arcjet Nosecone with Bun"
  deno: "Arcjet Nosecone with Deno"
  next-js: "Arcjet Nosecone with Next.js"
  node-js: "Arcjet Nosecone with Node.js"
  sveltekit: "Arcjet Nosecone with SvelteKit"
...
<FrameworkLinks
  ...
  exclude={["bun-hono", "nest-js", "node-js-express", "node-js-hono", "remix"]}
  client:load
/>
