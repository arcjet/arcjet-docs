...
titleByFramework:
  default: "Arcjet Nosecone: security headers for JS frameworks"
  bun: "Arcjet Nosecone: security headers for Bun"
  deno: "Arcjet Nosecone: security headers for Deno"
...
[<NpmSdkVersion label="✦Aj Nosecone" packageName="nosecone" />](https://www.npmjs.com/package/nosecone)
...
For full details on each option, see the <Link.Page
href="/nosecone/reference">reference guide</Link.Page>.
...
This guide shows you how to add our recommended <FrameworkName client:load/>
