...
| `actor` | No | Trusted identity, or a callable of the hook envelope. |
| `inputs` | No | Named values built with `server_input.*` or `local_input.*`, or a callable of the hook envelope. |
