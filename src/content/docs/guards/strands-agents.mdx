...
An interrupt pauses the run for human-in-the-loop (HITL) confirmation. It asks
a person rather than evaluating a policy, so it is not a Guard enforcement
...
- JavaScript example:
  [examples/strands-agent](https://github.com/arcjet/examples/tree/main/examples/strands-agent)
- Python example:
  [examples/fastapi-strands-agents-guard](https://github.com/arcjet/arcjet-py/tree/main/examples/fastapi-strands-agents-guard)
- Python adapter:
  [`ed8b5766`](https://github.com/arcjet/arcjet-py/commit/ed8b57669f9d7a5db890328e376099742c03fcf3)
