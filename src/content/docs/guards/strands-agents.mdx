...
```bash
npm install github:arcjet/arcjet-js#f3a07ee675cbdd812a36dcb778ee4325d2f89617 @strands-agents/sdk
```
...
- Adapter: [`f3a07ee6`](https://github.com/arcjet/arcjet-js/commit/f3a07ee675cbdd812a36dcb778ee4325d2f89617)
