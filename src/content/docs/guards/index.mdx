...
## Monitor and manage with MCP

Once guards are in place, connect the <Link.Page href="/mcp-server">Arcjet MCP server</Link.Page> to your AI coding tool to monitor traffic, inspect decisions, investigate IPs, and manage remote rules — all from your editor. This is optional but recommended for ongoing visibility.

Alternatively, the Arcjet CLI (coming soon) will provide the same management capabilities from the command line.
