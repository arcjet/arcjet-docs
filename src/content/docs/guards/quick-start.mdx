...
for `guardTool` options and `toolsContext`,
<Link.Page href="/guards/langchain">LangChain</Link.Page>
for Python tools and `create_agent`,
<Link.Page href="/guards/vercel-eve">Vercel Eve</Link.Page>
for Eve channels and connections,
<Link.Page href="/guards/mastra">Mastra</Link.Page>
for processors, tools, and hooks, or
<Link.Page href="/guards/remote-policies">Remote policies</Link.Page> for the full input and rule reference.
