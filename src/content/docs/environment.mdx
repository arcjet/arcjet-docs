...
Arcjet uses [`@arcjet/env`][github-arcjet-env] to read info from the
environment.
...
[arcjet-client-ip]: /concepts/client-ip
[github-arcjet-env]: https://github.com/arcjet/arcjet/tree/main/packages/env
