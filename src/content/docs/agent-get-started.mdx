...
2. List recent decisions with the CLI (`arcjet requests list --site-id <id>` for
   ...
   or the MCP tools (`list-requests`, `list-guards`). Results are limited to
   the plan retention window.
...
5. Check the [Arcjet Console](https://app.arcjet.com) for real-time
   monitoring.
