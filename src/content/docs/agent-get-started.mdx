...
| ----------------------------------------------------------- | --------------------------------------------------------------------------- |
| A developer's coding agent (Claude Code, GitHub Copilot, OpenAI Codex, Cursor) | [Secure the coding agent](#secure-the-coding-agent). No package to install. |
...
- **An agent framework in either manifest** (`ai`, `eve`, `genkit`,
  ...
  `@google/adk`, `google-adk`, `@cloudflare/think`, `@strands-agents/sdk`, `@tanstack/ai`, or `crewai`) means the
...
already fires. See [Claude Code](/coding-agents/claude-code),
[GitHub Copilot](/coding-agents/copilot),
[OpenAI Codex](/coding-agents/codex), and
[Cursor](/coding-agents/cursor).
...
| Google ADK Python     | `pip install "arcjet[google-adk]"`                                                               |
...
Google ADK Python is Python-only. Cloudflare Think is JavaScript-only.
...
Labels are slugs: lowercase letters, digits, dash, underscore, and dot. They
...
The hooks Claude Code, GitHub Copilot, OpenAI Codex, and Cursor already fire can call Arcjet before
