---
title: "Bun signup form protection reference"
description: "How to use Arcjet to protect signup forms in Bun."
---

import { Code, TabItem, Tabs } from "@astrojs/starlight/components";
import CustomVerificationJS from "/src/content/docs/signup-protection/reference/snippets/bun/CustomVerification.js?raw";
import CustomVerificationTS from "/src/content/docs/signup-protection/reference/snippets/bun/CustomVerification.ts?raw";
import ErrorHandlingJS from "/src/content/docs/signup-protection/reference/snippets/bun/Errors.js?raw";
import ErrorHandlingTS from "/src/content/docs/signup-protection/reference/snippets/bun/Errors.ts?raw";
import RecommendedTS from "/src/content/docs/signup-protection/reference/snippets/bun/Recommended.ts?raw";
...
limiting](/rate-limiting/quick-start/bun), [bot
protection](/bot-protection/quick-start/bun), and [email
validation](/email-validation/quick-start/bun) primitives. The configuration
