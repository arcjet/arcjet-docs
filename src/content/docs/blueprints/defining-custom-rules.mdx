...
description: "Write a custom Arcjet rule when the built-in rules don't cover your case, including how the rule protocol works and how to combine a custom rule with the built-in ones."
---
...
run only locally, because the Arcjet service doesn't know about them; however,
they can still be useful for some use cases.
...
Arcjet executes this custom rule and denies the request if the body doesn't pass
validation.
