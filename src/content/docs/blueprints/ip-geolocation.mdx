...
- Decisions after calling `protect()` include IP address analysis fields. You
  can use this to customize responses. For details, see the SDK reference for
  your framework, such as
  <Link.Page href="/reference/nextjs#ip-analysis">Next.js</Link.Page>.
...
<Aside type="caution">
  ...
  mislocated. These fields are provided for convenience, such as suggesting a
  user location, but don't rely on them alone.
</Aside>
