...
titleByFramework:
  default: "Shield WAF"
  bun: "Shield WAF with Bun"
  nest-js: "Shield WAF with NestJS"
  next-js: "Shield WAF with Next.js"
  node-js: "Shield WAF with Node.js"
  remix: "Shield WAF with Remix"
  sveltekit: "Shield WAF with SvelteKit"
