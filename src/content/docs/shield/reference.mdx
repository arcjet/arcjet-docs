...
description: "Reference guide for adding Arcjet Shield WAF to your Next.js, Node.js, Bun, Python, Remix, or SvelteKit app."
frameworks:
  - bun
  - nest-js
  - next-js
...
import DecisionLogPythonFastapi from "@/snippets/shield/reference/python-fastapi/DecisionLog.mdx";
import ErrorsPythonFastapi from "@/snippets/shield/reference/python-fastapi/Errors.mdx";
import DecisionLogPythonFlask from "@/snippets/shield/reference/python-flask/DecisionLog.mdx";
import ErrorsPythonFlask from "@/snippets/shield/reference/python-flask/Errors.mdx";
...
To check whether a shield rule returned a deny conclusion, use
`decision.isDenied()` and `decision.reason.isShield()` (JS) /
`decision.is_denied()` and `decision.reason_v2.type == "SHIELD"` (Python).
