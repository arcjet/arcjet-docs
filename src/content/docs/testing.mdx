...
effect ran. When you test a framework wrapper, assert `metadata.outcome`
as well. See
...
GitHub](https://github.com/arcjet/examples/tree/main/examples/express-newman).
The key files are:

- [`index.js`](https://github.com/arcjet/examples/blob/main/examples/express-newman/index.js)
  is a small Express server that uses Arcjet to protect several routes. This is
  the application being tested.
- [`tests/api.test.js`](https://github.com/arcjet/examples/blob/main/examples/express-newman/tests/api.test.js)
  is the test runner which loads the test definitions, executes them with
  Newman, and then asserts the expected results.
- The
  [`tests/bots.json`](https://github.com/arcjet/examples/blob/main/examples/express-newman/tests/bots.json),
  [`tests/high-rate-limit.json`](https://github.com/arcjet/examples/blob/main/examples/express-newman/tests/high-rate-limit.json),
  and
  [`tests/low-rate-limit.json`](https://github.com/arcjet/examples/blob/main/examples/express-newman/tests/low-rate-limit.json)
...
The example
[`README`](https://github.com/arcjet/examples/tree/main/examples/express-newman)
