...
import SamplingMiddlewareTS from "/src/content/docs/reference/snippets/nextjs/SamplingMiddleware.ts?raw";
import SamplingMiddlewareJS from "/src/content/docs/reference/snippets/nextjs/SamplingMiddleware.js?raw";
