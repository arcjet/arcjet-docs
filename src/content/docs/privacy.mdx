...
However, we do process some data remotely through our real-time decision API to
...
analyze request details. Additionally, our real-time cloud decision API
processes some data to:
...
- Request IP address.
- Request headers.
- If you use [custom characteristics](/architecture#custom-characteristics) for
  request [fingerprinting](/architecture#fingerprinting): any provided
  characteristics.
