...
These are [listed and explained][list-of-environment-variables] in this article.

Arcjet recommends using [`.env` files][dotenv-files] in development and to use
the dashboard provided by your hosting platform in production.
