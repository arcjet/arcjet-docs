...
Arcjet recommends [defining environment variables][section-define] with `.env`
files in development and to use the dashboard provided by your hosting platform
in production.
