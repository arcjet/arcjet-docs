...
Arcjet recommends [defining environment variables][section-define] based on the guidance and best practices of your chosen framework and hosting provider.
...
*Note that when deployed to Fly.io the default is automatically changed to `"https://fly.decide.arcjet.com"`.
...
You can also pass environment variables as you run your project:

```sh
ARCJET_LOG_LEVEL=debug node server.js
```
