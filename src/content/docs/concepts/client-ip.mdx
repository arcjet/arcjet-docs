...
| Firebase   | `x-fah-client-ip`, `x-forwarded-for`                                                                                                                                                               |
...
you can configure `services`.

TODO: `services` option is not real yet (arcjet/arcjet-js#5379).\
TODO: `@arcjet/services` is not real yet (arcjet/arcjet-js#5381).\
TODO: framework switcher in the following code block.

```ts
import arcjetBun from "@arcjet/bun";
import { cloudflare } from "@arcjet/services";
import { env } from "bun";
