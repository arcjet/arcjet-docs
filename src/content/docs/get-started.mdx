...
<CardGrid>
  ...
  <Link.Card
    ...
    description="Wrap tools in Vercel AI SDK, LangChain, LangChain JS, CrewAI, LangGraph, Genkit, OpenAI Agents, OpenAI Agents Python, Strands Agents, Eve, Mastra, and Claude Agent SDK."
  />
  <Link.Card
