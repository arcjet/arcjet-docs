...
import FastifyStep0 from "@/snippets/get-started/fastify/Step0.mdx";
...
import NuxtStep0 from "@/snippets/get-started/nuxt/Step0.mdx";
...
import PythonFastapiStep0 from "@/snippets/get-started/python-fastapi/Step0.mdx";
...
import PythonFlaskStep0 from "@/snippets/get-started/python-flask/Step0.mdx";
...
import ReactRouterStep0 from "@/snippets/get-started/react-router/Step0.mdx";
...
<SlotByFramework client:load>
  <AstroStep0 slot="astro" />
  <BunStep0 slot="bun" />
  <BunHonoStep0 slot="bun-hono" />
  <DenoStep0 slot="deno" />
  <FastifyStep0 slot="fastify" />
  ...
  <NuxtStep0 slot="nuxt" />
  <PythonFastapiStep0 slot="python-fastapi" />
  <PythonFlaskStep0 slot="python-flask" />
  <ReactRouterStep0 slot="react-router" />
