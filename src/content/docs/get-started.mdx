...
<Aside type="tip">
  Using an AI coding assistant? See the <Link.Page href="/agent-get-started">Agent
  Get Started</Link.Page> guide, or tell your agent: *"Set up Arcjet security for
  my app. Connect to the Arcjet MCP server to get my API key, then add shield,
