...
import AddingRulesTS from "/src/content/docs/bot-protection/reference/snippets/bun/AddingRules.ts?raw";
import AddingRulesJS from "/src/content/docs/bot-protection/reference/snippets/bun/AddingRules.js?raw";
import RemovingRulesTS from "/src/content/docs/bot-protection/reference/snippets/bun/RemovingRules.ts?raw";
import RemovingRulesJS from "/src/content/docs/bot-protection/reference/snippets/bun/RemovingRules.js?raw";
...
import BotTypeTS from "/src/content/docs/bot-protection/reference/snippets/bun/BotType.ts?raw";
import BotTypeJS from "/src/content/docs/bot-protection/reference/snippets/bun/BotType.js?raw";
...
<Tabs>
  <TabItem label="TS">
    <Code code={AddingRulesTS} lang="ts" />
  </TabItem>
  <TabItem label="JS">
    <Code code={AddingRulesJS} lang="js" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="TS">
    <Code code={RemovingRulesTS} lang="ts" />
  </TabItem>
  <TabItem label="JS">
    <Code code={RemovingRulesJS} lang="js" />
  </TabItem>
</Tabs>

## Decision

The [quick start example](/bot-protection/quick-start/bun) will deny requests
