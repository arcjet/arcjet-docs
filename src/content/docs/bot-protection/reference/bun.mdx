---
title: "Bun bot protection reference"
description: "How to use Arcjet to protect your Bun server from bots."
---

import { Tabs, TabItem, Code } from "@astrojs/starlight/components";
import AllowingBotsTS from "/src/content/docs/bot-protection/reference/snippets/bun/AllowingBots.ts?raw";
import AllowingBotsJS from "/src/content/docs/bot-protection/reference/snippets/bun/AllowingBots.js?raw";
import DenyingBotsTS from "/src/content/docs/bot-protection/reference/snippets/bun/DenyingBots.ts?raw";
import DenyingBotsJS from "/src/content/docs/bot-protection/reference/snippets/bun/DenyingBots.js?raw";
import DecisionLogTS from "/src/content/docs/bot-protection/reference/snippets/bun/DecisionLog.ts?raw";
import DecisionLogJS from "/src/content/docs/bot-protection/reference/snippets/bun/DecisionLog.js?raw";
import IdentifiedBotsTS from "/src/content/docs/bot-protection/reference/snippets/bun/IdentifiedBots.ts?raw";
import IdentifiedBotsJS from "/src/content/docs/bot-protection/reference/snippets/bun/IdentifiedBots.js?raw";
import ErrorsTS from "/src/content/docs/bot-protection/reference/snippets/bun/Errors.ts?raw";
import ErrorsJS from "/src/content/docs/bot-protection/reference/snippets/bun/Errors.js?raw";
...
Most applications want to block most of the ~600 bots we will detect. However,
it is common to allow some bots to access your system, such as bots for search
indexing or application monitoring.

This behavior is configured with an `allow` list, as shown here:
...
If you know which bots you'd explicitly like to deny, you'll configure a `deny`
list, as shown here:
...
bots](/bot-protection/identifying-bot) detected from the request. A request may
...
:::note
If the request is missing a User-Agent header, the decision will be marked as an
error! You should check for this and make a decision about the request since
requests without a User-Agent could indicate a crafted request from an automated
client.
:::
