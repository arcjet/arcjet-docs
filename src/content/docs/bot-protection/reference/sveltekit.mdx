...
import AllowingBotsTS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/AllowingBots.ts?raw";
import AllowingBotsJS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/AllowingBots.js?raw";
import DenyingBotsTS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/DenyingBots.ts?raw";
import DenyingBotsJS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/DenyingBots.js?raw";
...
import IdentifiedBotsTS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/IdentifiedBots.ts?raw";
import IdentifiedBotsJS from "/src/content/docs/bot-protection/reference/snippets/sveltekit/IdentifiedBots.js?raw";
...
<Tabs>
  <TabItem label="TS">
    <Code code={ErrorsTS} title="/app/api/arcjet/route.ts" lang="ts" />
  </TabItem>
  <TabItem label="JS">
    <Code code={ErrorsJS} title="/app/api/arcjet/route.js" lang="js" />
  </TabItem>
</Tabs>
