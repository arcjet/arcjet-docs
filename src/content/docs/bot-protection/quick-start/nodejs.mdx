...
import Step3TS from "/src/content/docs/bot-protection/quick-start/snippets/nodejs/Step3.ts?raw";
import Step3JS from "/src/content/docs/bot-protection/quick-start/snippets/nodejs/Step3.js?raw";
...
guide](/bot-protection/reference/nodejs#removing-bot-detection-rules) for how to
configure this.
