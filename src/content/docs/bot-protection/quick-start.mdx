...
<Link.Page href="/bot-protection/reference#allowing-specific-bots">allow specific bots</Link.Page>
or only
<Link.Page href="/bot-protection/reference#denying-specific-bots">deny specific bots</Link.Page>.

Bots can be identified individually or through managed categories. See
<Link.Page href="/bot-protection/identifying-bots">Identifying Bots</Link.Page> for more details.
