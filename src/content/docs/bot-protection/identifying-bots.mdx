...
Arcjet lets you configure a list of bots to allow or deny. To construct the
list, you can specify individual bots, use categories to allow or deny all bots
in a category, or both.
