...
<TextByFramework framework="next-js" client:load>
...
or per route guards. However these can't be used for email validation rules
...
[bot protection](/bot-protection/quick-start) for an example where guards are used.
