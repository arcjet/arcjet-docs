...
titleByFramework:
  ...
  bun: "Email validation with Bun"
  nest-js: "Email validation with NestJS"
  next-js: "Email validation with Next.js"
  node-js: "Email validation with Node.js"
  remix: "Email validation with Remix"
  sveltekit: "Email validation with SvelteKit"
