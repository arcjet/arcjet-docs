...
import DecisionLogJS from "/src/content/docs/email-validation/reference/snippets/sveltekit/DecisionLog.js?raw";
import DecisionLogTS from "/src/content/docs/email-validation/reference/snippets/sveltekit/DecisionLog.ts?raw";
import ErrorsJS from "/src/content/docs/email-validation/reference/snippets/sveltekit/Errors.js?raw";
import ErrorsTS from "/src/content/docs/email-validation/reference/snippets/sveltekit/Errors.ts?raw";
