...
import ErrorsJS from "/src/snippets/email-validation/reference/nodejs/Errors.js?raw";
import ErrorsTS from "/src/snippets/email-validation/reference/nodejs/Errors.ts?raw";
