---
title: "Node.js email validation reference"
description: "How to use Arcjet to add email validation to your Node.js server."
---

import { Aside, Code, TabItem, Tabs } from "@astrojs/starlight/components";
import DecisionLogJS from "/src/content/docs/email-validation/reference/snippets/nodejs/DecisionLog.js?raw";
import DecisionLogTS from "/src/content/docs/email-validation/reference/snippets/nodejs/DecisionLog.ts?raw";
import ErrorsJS from "/src/content/docs/email-validation/reference/snippets/nodejs/Errors.js?raw";
import ErrorsTS from "/src/content/docs/email-validation/reference/snippets/nodejs/Errors.ts?raw";
