...
Unless you are doing something custom, we recommend using
one of the adapters.
...
<Link.ToSdk href="/sensitive-info/reference#accessing-the-body" sdk="node">Accessing the body</Link.ToSdk> section of the reference.
