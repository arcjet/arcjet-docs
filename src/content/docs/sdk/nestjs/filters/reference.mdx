---
title: "Filters reference for NestJS"
description: "Reference guide for filtering requests with Arcjet in your NestJS app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/nestjs/Allow.mdx";
...
<DisplayType from="@arcjet/nest" type="FilterOptions" />
<DisplayType from="@arcjet/nest" type="ArcjetMode" />
