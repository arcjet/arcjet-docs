---
title: "Arcjet Nosecone: security headers for Node.js"
description: "How to use the open source Arcjet Nosecone library to set security headers (CSP, HSTS, and others) in your Node.js app."
prev: false
next: false
---
...
import Step1 from "@/snippets/nosecone/quick-start/node-js/Step1.mdx";
import Step2 from "@/snippets/nosecone/quick-start/node-js/Step2.mdx";
import Step3 from "@/snippets/nosecone/quick-start/node-js/Step3.mdx";
import Step4 from "@/snippets/nosecone/quick-start/node-js/Step4.mdx";
...
This guide will show you how to add our recommended Node.js
