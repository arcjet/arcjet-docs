...
description: "Getting started with Arcjet. Quick start guide to protect your app from attacks, apply a rate limit, and prevent bots from accessing your Node.js + Hono app."
prev: false
next: false
---
...
import Step0 from "@/snippets/get-started/node-js-hono/Step0.mdx";
import Step1 from "@/snippets/get-started/node-js-hono/Step1.mdx";
import Requirements from "@/snippets/get-started/node-js-hono/Requirements.mdx";
import Step2 from "@/snippets/get-started/node-js-hono/Step2.mdx";
import Step3 from "@/snippets/get-started/node-js-hono/Step3.mdx";
import Step4 from "@/snippets/get-started/node-js-hono/Step4.mdx";
