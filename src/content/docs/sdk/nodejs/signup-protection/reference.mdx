---
title: "Signup form protection reference for Node.js"
description: "Reference guide for adding Arcjet email validation to your Node.js app."
---

import Comments from "/src/components/Comments.astro";

import Recommended from "@/snippets/signup-protection/reference/nodejs/Recommended.mdx";
import CustomVerification from "@/snippets/signup-protection/reference/nodejs/CustomVerification.mdx";
import Errors from "@/snippets/signup-protection/reference/nodejs/Errors.mdx";
