---
title: "Email validation reference for Node.js"
description: "Reference guide for adding Arcjet email validation to your Node.js app."
---
...
import DecisionLogAllow from "@/snippets/email-validation/reference/nodejs/DecisionLogAllow.mdx";
import DecisionLogDeny from "@/snippets/email-validation/reference/nodejs/DecisionLogDeny.mdx";
import Errors from "@/snippets/email-validation/reference/nodejs/Errors.mdx";
...
<DisplayType type="EmailOptions" from="@arcjet/node" />
<DisplayType type="ArcjetMode" from="@arcjet/node" />
<DisplayType type="ArcjetEmailType" from="@arcjet/node" />
