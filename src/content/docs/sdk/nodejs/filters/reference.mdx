---
title: "Filters reference for Node.js"
description: "Reference guide for filtering requests with Arcjet in your Node.js app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/nodejs/Allow.mdx";
...
<DisplayType from="@arcjet/node" type="FilterOptions" />
<DisplayType from="@arcjet/node" type="ArcjetMode" />
