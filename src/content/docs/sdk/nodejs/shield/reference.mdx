---
title: "Shield WAF reference for Node.js"
description: "Reference guide for adding Arcjet Shield WAF to your Node.js app."
---

import DisplayType from "@/components/DisplayType.astro";

import DecisionLog from "@/snippets/shield/reference/nodejs/DecisionLog.mdx";
import Errors from "@/snippets/shield/reference/nodejs/Errors.mdx";
...
<DisplayType type="ShieldOptions" from="@arcjet/node" />
