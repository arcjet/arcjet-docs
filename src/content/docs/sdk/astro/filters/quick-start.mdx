---
description: "Quick start guide for adding Arcjet filters to your Astro app."
title: "Filters for Astro"
---
...
import Step1 from "@/snippets/shared/astro/Install.mdx";
import Step2 from "@/snippets/get-started/astro/Step2.mdx";
import Step3 from "@/snippets/filters/quick-start/astro/Step3.mdx";
import Step4 from "@/snippets/filters/quick-start/astro/Step4.mdx";
...
This guide shows how to protect your Astro app with
filters.
...
<CardGrid>
  ...
  <LinkCard
    title="SDK reference"
    href="/sdk/astro/reference"
    description="Astro SDK reference guide."
  />
</CardGrid>
