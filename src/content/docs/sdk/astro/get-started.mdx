...
description: "Getting started with Arcjet. Quick start guide to protect your app from attacks, apply a rate limit, and prevent bots from accessing your Astro app."
prev: false
next: false
---
...
import Step0 from "@/snippets/get-started/astro/Step0.mdx";
...
import Step3 from "@/snippets/get-started/astro/Step3.mdx";
import Step4 from "@/snippets/get-started/astro/Step4.mdx";
