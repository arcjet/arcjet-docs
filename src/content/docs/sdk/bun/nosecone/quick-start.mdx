---
title: "Arcjet Nosecone: security headers for Bun"
description: "How to use the open source Arcjet Nosecone library to set security headers (CSP, HSTS, and others) in your Bun app."
prev: false
next: false
---
...
import Step1 from "@/snippets/nosecone/quick-start/bun/Step1.mdx";
import Step2 from "@/snippets/nosecone/quick-start/bun/Step2.mdx";
import Step3 from "@/snippets/nosecone/quick-start/bun/Step3.mdx";
import Step4 from "@/snippets/nosecone/quick-start/bun/Step4.mdx";
...
This guide will show you how to add our recommended Bun
