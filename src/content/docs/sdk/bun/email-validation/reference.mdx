---
title: "Email validation reference for Bun"
description: "Reference guide for adding Arcjet email validation to your Bun app."
---
...
import DecisionLogAllow from "@/snippets/email-validation/reference/bun/DecisionLogAllow.mdx";
import DecisionLogDeny from "@/snippets/email-validation/reference/bun/DecisionLogDeny.mdx";
import Errors from "@/snippets/email-validation/reference/bun/Errors.mdx";
...
<DisplayType type="EmailOptions" from="@arcjet/bun" />
<DisplayType type="ArcjetMode" from="@arcjet/bun" />
<DisplayType type="ArcjetEmailType" from="@arcjet/bun" />
