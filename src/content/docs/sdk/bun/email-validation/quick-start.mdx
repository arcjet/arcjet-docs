...
description: "Quick start guide for adding Arcjet email validation to your Bun app."
---
...
import Step1 from "@/snippets/email-validation/quick-start/bun/Step1.mdx";
...
import Step3 from "@/snippets/email-validation/quick-start/bun/Step3.mdx";
import Step4 from "@/snippets/email-validation/quick-start/bun/Step4.mdx";
