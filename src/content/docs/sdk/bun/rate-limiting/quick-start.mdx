...
description: "Quick start guide for adding Arcjet rate limiting to your Bun app."
---
...
import Step1 from "@/snippets/rate-limiting/quick-start/bun/Step1.mdx";
import Step2 from "@/snippets/rate-limiting/quick-start/bun/Step2.mdx";
import Step3 from "@/snippets/rate-limiting/quick-start/bun/Step3.mdx";
import Step4 from "@/snippets/rate-limiting/quick-start/bun/Step4.mdx";
...
This guide will show you how to add a simple rate limit to your Bun app.
