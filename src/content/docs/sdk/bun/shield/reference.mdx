---
title: "Shield WAF reference for Bun"
description: "Reference guide for adding Arcjet Shield WAF to your Bun app."
---

import DisplayType from "@/components/DisplayType.astro";

import DecisionLog from "@/snippets/shield/reference/bun/DecisionLog.mdx";
import Errors from "@/snippets/shield/reference/bun/Errors.mdx";
...
<DisplayType type="ShieldOptions" from="@arcjet/bun" />
