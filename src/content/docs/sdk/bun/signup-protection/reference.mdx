---
title: "Signup form protection reference for Bun"
description: "Reference guide for adding Arcjet email validation to your Bun app."
---

import Comments from "/src/components/Comments.astro";

import Recommended from "@/snippets/signup-protection/reference/bun/Recommended.mdx";
import CustomVerification from "@/snippets/signup-protection/reference/bun/CustomVerification.mdx";
import Errors from "@/snippets/signup-protection/reference/bun/Errors.mdx";
