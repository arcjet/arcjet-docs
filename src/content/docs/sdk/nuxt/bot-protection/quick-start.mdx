---
title: "Bot protection for Nuxt"
description: "Quick start guide for adding Arcjet bot protection to your Nuxt app."
---
...
import Step1 from "@/snippets/shared/nuxt/InstallWithInspect.mdx";
import Step2 from "@/snippets/shared/nuxt/Key.mdx";
import Step3 from "@/snippets/bot-protection/quick-start/nuxt/Step3.mdx";
import Step4 from "@/snippets/bot-protection/quick-start/nuxt/Step4.mdx";
...
This guide will show you how to protect your Nuxt
...
<CardGrid>
  ...
  <LinkCard
    title="SDK reference"
    href="/sdk/nuxt/reference"
    description="Nuxt SDK reference guide."
  />
</CardGrid>
