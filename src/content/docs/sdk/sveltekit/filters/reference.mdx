---
title: "Filters reference for SvelteKit"
description: "Reference guide for filtering requests with Arcjet in your SvelteKit app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/sveltekit/Allow.mdx";
...
<DisplayType from="@arcjet/sveltekit" type="FilterOptions" />
<DisplayType from="@arcjet/sveltekit" type="ArcjetMode" />
