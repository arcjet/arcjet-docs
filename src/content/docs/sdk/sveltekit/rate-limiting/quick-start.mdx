...
description: "Quick start guide for adding Arcjet rate limiting to your SvelteKit app."
---
...
import Step1 from "@/snippets/rate-limiting/quick-start/sveltekit/Step1.mdx";
import Step2 from "@/snippets/rate-limiting/quick-start/sveltekit/Step2.mdx";
import Step3 from "@/snippets/rate-limiting/quick-start/sveltekit/Step3.mdx";
import Step4 from "@/snippets/rate-limiting/quick-start/sveltekit/Step4.mdx";
