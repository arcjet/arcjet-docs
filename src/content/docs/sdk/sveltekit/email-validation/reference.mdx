---
title: "Email validation reference for SvelteKit"
description: "Reference guide for adding Arcjet email validation to your SvelteKit app."
---
...
import DecisionLogAllow from "@/snippets/email-validation/reference/sveltekit/DecisionLogAllow.mdx";
import DecisionLogDeny from "@/snippets/email-validation/reference/sveltekit/DecisionLogDeny.mdx";
import Errors from "@/snippets/email-validation/reference/sveltekit/Errors.mdx";
...
<DisplayType type="EmailOptions" from="@arcjet/sveltekit" />
<DisplayType type="ArcjetMode" from="@arcjet/sveltekit" />
<DisplayType type="ArcjetEmailType" from="@arcjet/sveltekit" />
