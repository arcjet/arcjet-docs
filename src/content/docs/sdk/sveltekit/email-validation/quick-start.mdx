...
description: "Quick start guide for adding Arcjet email validation to your SvelteKit app."
---
...
import Step1 from "@/snippets/email-validation/quick-start/sveltekit/Step1.mdx";
import Step2 from "@/snippets/email-validation/quick-start/shared/Step2.mdx";
import Step3 from "@/snippets/email-validation/quick-start/sveltekit/Step3.mdx";
import Step4 from "@/snippets/email-validation/quick-start/sveltekit/Step4.mdx";
