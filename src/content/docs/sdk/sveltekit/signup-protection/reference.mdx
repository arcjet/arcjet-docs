---
title: "Signup form protection reference for SvelteKit"
description: "Reference guide for adding Arcjet email validation to your SvelteKit app."
---

import Comments from "/src/components/Comments.astro";

import Recommended from "@/snippets/signup-protection/reference/sveltekit/Recommended.mdx";
import CustomVerification from "@/snippets/signup-protection/reference/sveltekit/CustomVerification.mdx";
import Errors from "@/snippets/signup-protection/reference/sveltekit/Errors.mdx";
