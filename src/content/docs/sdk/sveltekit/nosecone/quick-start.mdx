---
title: "Arcjet Nosecone: security headers for SvelteKit"
description: "How to use the open source Arcjet Nosecone library to set security headers (CSP, HSTS, and others) in your SvelteKit app."
prev: false
next: false
---
...
import Step1 from "@/snippets/nosecone/quick-start/sveltekit/Step1.mdx";
import Step2 from "@/snippets/nosecone/quick-start/sveltekit/Step2.mdx";
import Step3 from "@/snippets/nosecone/quick-start/sveltekit/Step3.mdx";
import Step4 from "@/snippets/nosecone/quick-start/sveltekit/Step4.mdx";
...
This guide will show you how to add our recommended SvelteKit
