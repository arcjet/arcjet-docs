...
description: "Getting started with Arcjet. Quick start guide to protect your app from attacks, apply a rate limit, and prevent bots from accessing your Next.js app."
prev: false
next: false
---
...
import Step0 from "@/snippets/get-started/next-js/Step0.mdx";
import Step1 from "@/snippets/get-started/next-js/Step1.mdx";
import Requirements from "@/snippets/get-started/next-js/Requirements.mdx";
import Step2 from "@/snippets/get-started/next-js/Step2.mdx";
import Step3 from "@/snippets/get-started/next-js/Step3.mdx";
import Step4 from "@/snippets/get-started/next-js/Step4.mdx";
