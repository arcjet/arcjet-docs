---
title: "Email validation reference for Next.js"
description: "Reference guide for adding Arcjet email validation to your Next.js app."
---
...
import DecisionLogAllow from "@/snippets/email-validation/reference/nextjs/DecisionLogAllow.mdx";
import DecisionLogDeny from "@/snippets/email-validation/reference/nextjs/DecisionLogDeny.mdx";
import Errors from "@/snippets/email-validation/reference/nextjs/Errors.mdx";
import PagesServerActions from "@/snippets/email-validation/reference/nextjs/PagesServerActions.mdx";
...
<DisplayType type="EmailOptions" from="@arcjet/next" />
<DisplayType type="ArcjetMode" from="@arcjet/next" />
<DisplayType type="ArcjetEmailType" from="@arcjet/next" />
