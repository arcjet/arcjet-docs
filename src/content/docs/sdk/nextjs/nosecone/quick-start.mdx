---
title: "Arcjet Nosecone: security headers for Next.js"
description: "How to use the open source Arcjet Nosecone library to set security headers (CSP, HSTS, and others) in your Next.js app."
prev: false
next: false
---
...
import Step1 from "@/snippets/nosecone/quick-start/next-js/Step1.mdx";
import Step2 from "@/snippets/nosecone/quick-start/next-js/Step2.mdx";
import Step3 from "@/snippets/nosecone/quick-start/next-js/Step3.mdx";
import Step4 from "@/snippets/nosecone/quick-start/next-js/Step4.mdx";
...
This guide will show you how to add our recommended Next.js
