---
title: "Signup form protection reference for Next.js"
description: "Reference guide for adding Arcjet email validation to your Next.js app."
---

import Comments from "/src/components/Comments.astro";

import Recommended from "@/snippets/signup-protection/reference/nextjs/Recommended.mdx";
import PagesServerActions from "@/snippets/signup-protection/reference/nextjs/PagesServerActions.mdx";
import CustomVerification from "@/snippets/signup-protection/reference/nextjs/CustomVerification.mdx";
import Errors from "@/snippets/signup-protection/reference/nextjs/Errors.mdx";
