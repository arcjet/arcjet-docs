...
description: "Quick start guide to protect your signup forms from abuse to your Next.js app with Arcjet Signup form protection."
---
...
import Step1 from "@/snippets/signup-protection/quick-start/nextjs/Step1.mdx";
import Step2 from "@/snippets/signup-protection/quick-start/shared/Step2.mdx";
import Step3 from "@/snippets/signup-protection/quick-start/nextjs/Step3.mdx";
...
This guide will show you how to protect your Next.js signup form from common attacks.
...
instructions to add a site and get a key. Add it to a `.env.local` file in your Next.js project root.
