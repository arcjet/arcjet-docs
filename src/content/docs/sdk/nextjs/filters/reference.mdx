---
title: "Filters reference for Next.js"
description: "Reference guide for filtering requests with Arcjet in your Next.js app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/nextjs/Allow.mdx";
...
<DisplayType from="@arcjet/next" type="FilterOptions" />
<DisplayType from="@arcjet/next" type="ArcjetMode" />
