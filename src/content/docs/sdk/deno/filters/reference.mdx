---
title: "Filters reference for Deno"
description: "Reference guide for filtering requests with Arcjet in your Deno app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/deno/Allow.mdx";
...
<DisplayType from="@arcjet/deno" type="FilterOptions" />
<DisplayType from="@arcjet/deno" type="ArcjetMode" />
