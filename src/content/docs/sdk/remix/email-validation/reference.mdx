---
title: "Email validation reference for Remix"
description: "Reference guide for adding Arcjet email validation to your Remix app."
---
...
import DecisionLogAllow from "@/snippets/email-validation/reference/remix/DecisionLogAllow.mdx";
import DecisionLogDeny from "@/snippets/email-validation/reference/remix/DecisionLogDeny.mdx";
import Errors from "@/snippets/email-validation/reference/remix/Errors.mdx";
...
<DisplayType type="EmailOptions" from="@arcjet/remix" />
<DisplayType type="ArcjetMode" from="@arcjet/remix" />
<DisplayType type="ArcjetEmailType" from="@arcjet/remix" />
