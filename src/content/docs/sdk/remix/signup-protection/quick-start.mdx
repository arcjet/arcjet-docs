---
title: "Signup form protection for Remix"
description: "Quick start guide to protect your signup forms from abuse to your Remix app with Arcjet Signup form protection."
---
...
import Step1 from "@/snippets/signup-protection/quick-start/remix/Step1.mdx";
import Step2 from "@/snippets/signup-protection/quick-start/shared/Step2.mdx";
import Step3 from "@/snippets/signup-protection/quick-start/remix/Step3.mdx";
import Step4 from "@/snippets/signup-protection/quick-start/remix/Step4.mdx";
...
This guide will show you how to protect your Remix signup form from common attacks.
...
instructions to add a site and get a key. Add it to a `.env.local` file in your Remix project root.
