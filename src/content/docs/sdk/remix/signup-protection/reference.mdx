---
title: "Signup form protection reference for Remix"
description: "Reference guide for adding Arcjet email validation to your Remix app."
---

import Comments from "/src/components/Comments.astro";

import Recommended from "@/snippets/signup-protection/reference/remix/Recommended.mdx";
import CustomVerification from "@/snippets/signup-protection/reference/remix/CustomVerification.mdx";
import Errors from "@/snippets/signup-protection/reference/remix/Errors.mdx";
