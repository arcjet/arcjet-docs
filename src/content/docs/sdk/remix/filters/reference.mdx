---
title: "Filters reference for Remix"
description: "Reference guide for filtering requests with Arcjet in your Remix app."
---

import { Badge } from "@astrojs/starlight/components";
import DisplayType from "@/components/DisplayType.astro";
import Allow from "@/snippets/filters/reference/remix/Allow.mdx";
...
<DisplayType from="@arcjet/remix" type="FilterOptions" />
<DisplayType from="@arcjet/remix" type="ArcjetMode" />
