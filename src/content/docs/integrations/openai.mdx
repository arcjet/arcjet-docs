...
- Arcjet rate limits allow
  ...
  to identify the client and apply the limit. We
  provide the user ID to identify the user. This can use any authentication
  system you have in place, such as
  <Link.Page href="/integrations/clerk">Clerk</Link.Page>.
