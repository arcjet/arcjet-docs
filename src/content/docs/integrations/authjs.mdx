...
<Aside type="note" title="NextAuth 4 and Auth.js 5">
  ...
  [Auth.js](https://authjs.dev/) 5. See the{" "}
  <Link.Page href="/integrations/nextauth">Arcjet / NextAuth integration docs</Link.Page>{" "}
  for instructions specific to the old (stable) version.
</Aside>
...
to identify the client and apply the limit. Using the Auth.js
...
it through Next.js middleware. Auth.js can also use middleware to add
authentication to your pages. You can chain the two together.
