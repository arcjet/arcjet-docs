...
[LLM](https://docs.langchain.com/oss/javascript/langchain/overview) and [Chat
Model](https://docs.langchain.com/oss/javascript/langchain/models) calls to
...
SDK](https://docs.langchain.com/oss/javascript/langchain/overview).
...
- `@langchain/community` 1.0.0 or later
...
- `contextWindowSize` - How many tokens to pass to the `detect` function at a
  ...
  determining if a token is sensitive or not.
