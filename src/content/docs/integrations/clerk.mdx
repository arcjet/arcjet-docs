...
import NextJSClerkApp from "/src/content/docs/integrations/snippets/ClerkNextJSApp.ts?raw";
import NextJSClerkMiddleware from "/src/content/docs/integrations/snippets/ClerkNextJSMiddleware.ts?raw";
import NextJSClerkPages from "/src/content/docs/integrations/snippets/ClerkNextJSPages.ts?raw";
import NextJSClerkAJMiddleware from "/src/content/docs/integrations/snippets/ClerkNextJSAJMiddleware.ts?raw";
...
See an [example Next.js implementation on
GitHub](https://github.com/arcjet/arcjet-js/tree/main/examples/nextjs-14-clerk-shield).
