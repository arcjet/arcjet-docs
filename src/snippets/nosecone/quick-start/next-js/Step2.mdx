...
Nosecone applies headers to all your routes with middleware in your Next.js
application.
...
<Aside type="note" title="Chaining middleware">
  See the <Link.Page href="/nosecone/reference#chain-middleware">reference guide</Link.Page> if you need
