...
Nosecone applies headers to all your routes with hooks in your SvelteKit
application.
...
SvelteKit provides the `Content-Security-Policy` header itself, so Nosecone
helps you to configure it.
