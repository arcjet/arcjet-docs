...
<Code code={Step3ConfigJS} lang="js" title="astro.config.mjs" />
...
{/* TODO(#): Correctly type the `arcjet:client` module in snippets */}

<Code
  code={Step3RouteTS.replace("// @ts-nocheck\n", "")}
  lang="ts"
  title="api.json.ts"
/>
...
<Code code={Step3RouteJS} lang="js" title="api.json.js" />
