...
<Aside type="note">
  Sensitive information detection is not supported in server actions because
  Next.js does not provide access to the request body. You can use the [redact
  utility](/redact/quick-start) instead.
</Aside>
