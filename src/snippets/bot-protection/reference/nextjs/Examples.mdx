...
supported, but you can set up a matcher on the middleware (renamed to proxy in Next.js 16) instead:

    <Code code={ProtectPageMiddlewareTS} lang="ts" title="/proxy.ts" />
...
supported, but you can set up a matcher on the middleware (renamed to proxy in Next.js 16) instead:
    ...
    <Code code={ProtectPageMiddlewareJS} lang="js" title="/proxy.js" />
