...
Make a `curl` request from your terminal to your application. You get a `403
Forbidden` response because `curl` is considered an automated client by default.
See <Link.Page href="/bot-protection/reference">the reference guide</Link.Page>
