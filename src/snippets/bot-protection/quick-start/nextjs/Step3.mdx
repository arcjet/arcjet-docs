...
Arcjet also works in <Link.Page href="/reference/nextjs#pages--page-components">page routes</Link.Page>,
<Link.Page href="/reference/nextjs#server-actions">server actions</Link.Page>, and <Link.Page href="/bot-protection/reference#per-route-vs-middleware">middleware (renamed to proxy in Next.js 16)</Link.Page>.
