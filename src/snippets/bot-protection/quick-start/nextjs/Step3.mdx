...
For this quick start, enable Arcjet Bot Protection on a single route handler.
This could be an API you want to protect, such as a form handler.

Arcjet also works in <Link.Page href="/reference/nextjs#pages-and-page-components">page routes</Link.Page>,
<Link.Page href="/reference/nextjs#server-actions">server actions</Link.Page>, and <Link.Page href="/bot-protection/reference#per-route-versus-middleware">middleware (renamed to proxy in Next.js 16)</Link.Page>.
