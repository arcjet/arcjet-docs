...
For this quick start, enable Arcjet Bot Protection across of all the [dynamic
routes](https://docs.astro.build/en/guides/routing/#dynamic-routes) in your
Astro application using [Astro middleware
](https://docs.astro.build/en/guides/middleware/). Learn about how to protect
static routes in our <Link.Page href="/reference/astro#static-routes">Astro SDK reference docs</Link.Page>.
